        ...
        if ($.isFunction($.fn.vectorMap)) {
            ...
            $(function() {
                $('#db-world-map-markers').vectorMap({
                    ...
                    backgroundColor: '#ffffff',
                    markers: [{
                        latLng: [25.038759, 121.565853],
                        name: '華新麗華總公司'
                    }, {
                        latLng: [23.342413, 120.279730],
                        name: '鹽水廠'
                    }, {
                        latLng: [24.246972, 120.511641],
                        name: '臺中廠'
                    }, {
                        latLng: [31.249983, 121.139569],
                        name: '上海白鶴華新麗華特殊鋼製品有限公司'
                    }, {
                        latLng: [31.730906, 120.801098],
                        name: '常熟華新特殊鋼有限公司'
                    }, {
                        latLng: [5.140546, 101.976824],
                        name: '華新精密科技股份有限公司'
                    }, {
                        latLng: [37.560447, 121.274452],
                        name: '煙台華新不銹鋼有限公司'
                    }]
                });
            });
